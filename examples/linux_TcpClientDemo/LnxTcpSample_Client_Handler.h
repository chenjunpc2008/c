#ifndef __LNX_TCP_SAMPLE_CLIENT_HANDLER_H__
#define __LNX_TCP_SAMPLE_CLIENT_HANDLER_H__

#include <memory.h>
#include <string>
#include <vector>

#include "tcp/linux_epoll_client/EpollClient_EventHandler.h"
#include "tcp/simple_net_pack/HandlerSocketMsg.h"

class LnxTcpSample_Client_Handler : public EpollClient_EventHandler
{
  protected:
  ...
  public:
    LnxTcpSample_Client_Handler(void);
    virtual ~LnxTcpSample_Client_Handler(void);
